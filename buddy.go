...
// A buddy system in go according to a C
// version(https://github.com/wuwenbin/buddy2)
...
func New(size int) (*Buddy, error) {
	...
	return &Buddy{size, longests}, nil
}
